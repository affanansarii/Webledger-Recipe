            ...
            {isLoading ? (
                ...
                >
                    ...
                    >
                        ...
                        {isAuth && (
                            <button
                                className="w-fit bg-red-500 text-white font-bold flex items-center gap-4 rounded-md"
                    ...
                    <div className="flex justify-start items-center gap-2">
                        <p
                            className="border rounded-md flex gap-2 items-center text-xs md:text-md"
                            style={{ padding: "5px 10px" }}
                        >
                            <MdPeople size={20} /> Servings: $
                        ...
                        >
                            ...
                            Vegiterian: {food?.vegiterian ? "Yes" : "No"}
                        </p>
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <div
                            className={`${
                                changeView === "grid" ? "flex" : "block w-full"
                            } gap-4 flex-wrap`}
                        >
                                ...
                                (ingredient, index) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <img
                                                src="https://tinyurl.com/2xzz98y4"
                                                alt=""
                                                className="h-18"
                                            />
                                            <div>
